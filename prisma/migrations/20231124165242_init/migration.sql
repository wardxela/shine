...
CREATE TABLE "ProductCounted" (
    ...
    CONSTRAINT "ProductCounted_pkey" PRIMARY KEY ("id")
);
...
-- AddForeignKey
ALTER TABLE "ProductCounted" ADD CONSTRAINT "ProductCounted_productId_fkey" FOREIGN KEY ("productId") REFERENCES "Product"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "ProductCounted" ADD CONSTRAINT "ProductCounted_cartId_fkey" FOREIGN KEY ("cartId") REFERENCES "Cart"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
